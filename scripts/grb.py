...
from gammapy.spectrum.models import PowerLaw, AbsorbedSpectralModel, Absorption
from gammapy.scripts import CTAPerf
from gammapy.scripts.cta_utils import (CTAObservationSimulation, Target,
                                       ObservationParameters)

from utils import get_differential_flux_from_integral_flux
...
grb_template['amplitude_template'] = get_differential_flux_from_integral_flux(
    emin=grb_template['int_emin'],
    emax=grb_template['int_emax'],
    eref=grb_template['eref'],
    gamma=grb_template['index_template'],
    int_flux=grb_template['int_flux']
)
